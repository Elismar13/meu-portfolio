...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="w-full flex flex-col lg:flex-row items-center justify-between bg-gray-800 text-white p-8">
      <div className="lg:w-2/3 text-center lg:text-left mb-8 lg:mb-0 max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Get in Touch</h1>
        <h2 className="text-3xl font-bold mb-4">Don't be Shy</h2>
        <p className="mb-4">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          <div className="flex items-center mb-2">
            ...
            <div>
              <span>WhatsApp</span>
              <span>(83) 98872-9338</span>
            </div>
          </div>
        </div>

        <form className="p-8 rounded-2xl bg-gray-800">
          <div className="mb-4">
            <input
